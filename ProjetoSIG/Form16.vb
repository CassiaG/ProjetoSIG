...
Public Class Form16
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim sql As String = "Select * from Ensaio where cod_cliente ='" + TextBox1.Text + "'"
        ...
        Try
            ...
            If dr.HasRows Then
                While dr.Read
                    If (dr.Item("cod_cliente") = Codigo) Then
                        ...
                        Label14.Text = dr.Item("valor_i")
                        TextBox11.Text = dr.Item("valor_e")
                        Label20.Text = dr.Item("valor_f")
                        ComboBox1.Text = dr.Item("Statu")
                        TextBox4.Text = dr.Item("Estudio")
            ...
            End If
            If flag = False Then
                MessageBox.Show("Banda não cadastrada em nenhum Ensaio", "Atenção")
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        '    MessageBox.Show("Já possui agendamentos para esse Dia", "Aviso")
        ...
        Dim sql As String
        sql = "update Ensaio set cod_cliente=@cod_cliente, nome_banda=@nome_banda, inicio=@inicio, termino=@termino, dia=@dia, Estudio=@Estudio, violao=@violao, guitarra=@guitarra, baixo=@baixo, pratos=@pratos, valor_e=@valor_e, valor_f=@valor_f, valor_i=@valor_i, Statu=@Statu, teclado=@teclado where cod_cliente ='" + TextBox1.Text + "'"
        ...
        cm.Parameters.AddWithValue("@valor_e", TextBox11.Text)
        cm.Parameters.AddWithValue("@valor_f", Label14.Text)
        cm.Parameters.AddWithValue("@valor_i", Label20.Text)
        cm.Parameters.AddWithValue("@Statu", ComboBox1.Text)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Dim flag As Boolean
        Dim sql As String = "Delete from Ensaio where cod_cliente ='" & Codigo & "'"
        Dim cm As New OleDbCommand(sql, DBCon)
        Dim dr As OleDb.OleDbDataReader
        Try
